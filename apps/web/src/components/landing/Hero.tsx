		...
		<>
			<section className="w-full overflow-hidden relative pb-[30vw] sm:pb-[0]">
				<div className="absolute w-full sm:w-[85%] md:w-[80%] lg:w-[75%] sm:left-4 md:left-8 lg:left-12 relative">
					...
					<div
						className={`${shadows.className} absolute w-[15%] top-[32.5%] left-[15%] rotate-[12deg] sm:top-[31%] font-semibold`}
					>
				...
				<div className=" transition delay-150 duration-400 ease-in-out hover:scale-110 absolute w-[30%] sm:w-[12.5%] lg:w-[17.5%] left-[36%] top-[74.5%] sm:top-[70%] sm:left-[83%] lg:top-[35%] lg:left-[77.5%]">
					<img
				...
				<div className="absolute transition delay-150 duration-400 ease-in-out hover:scale-110 w-[35%] sm:w-[18%] lg:w-[25%] top-[68%] left-[1%] sm:left-[82%] sm:top-[43%] md:left-[80%] lg:left-[75%] rotate-3 sm:-rotate-3">
					<img
				...
				<div className="absolute transition delay-150 duration-400 ease-in-out hover:scale-110 w-[25%] left-[22%] top-[83%] sm:w-[12.5%] sm:left-[82%] sm:top-[50%] lg:top-[55%] lg:left-[72.5%] lg:w-[17.5%]">
					<img
						src="/img/assets/blank-tape-stickers1.svg"
						alt=""
						className="w-full h-auto"
				...
				<div className="absolute transition delay-150 duration-400 ease-in-out hover:scale-110 w-[25%] left-[54.5%] top-[83%] sm:w-[12.5%] sm:left-[87%] sm:top-[55%] lg:top-[63%] lg:left-[80%] lg:w-[17.5%]">
					<img
						src="/img/assets/blank-tape-stickers1.svg"
						alt=""
						className="w-full h-auto"
				...
				<div className="absolute transition delay-150 duration-400 ease-in-out hover:scale-110 w-[25%] left-[37%] top-[90%] sm:w-[12.5%] sm:left-[82%] sm:top-[60%] lg:top-[72%] lg:left-[72.5%] lg:w-[17.5%]">
					<img
						src="/img/assets/blank-tape-stickers1.svg"
						alt=""
						className="w-full h-auto"
