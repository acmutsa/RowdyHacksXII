				...
				<div className={`relative w-[80cqw] h-auto ${manuale.className}`}>
					...
					<div className="relative flex flex-col p-[10%]">
						...
						<motion.img
							...
							className="h-auto w-[35%] rotate-[15deg] object-contain top-[-10%]"
						...
						<div className="w-full h-auto flex item-center justify-center border-b border-foreground pb-2">
							<p className=" text-center text-md font-bold leading-tight sm:text-lg md:text-xl lg:text-2xl xl:text-4xl 2xl:text-5xl">
								Title Sponsors
							</p>
						</div>
