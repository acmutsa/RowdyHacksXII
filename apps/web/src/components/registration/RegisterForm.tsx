																		...
																		<CommandGroup>
																			{c.registration.countries.map(
																				(
																					...
																					>
																						<Check
																							className={`mr-2 h-4 w-4 ${country.name.toLowerCase() ===
																								field.value
																								? "block"
																								: "hidden"
																								} `}
								...
								<FormGroupWrapper title="University Info">
									...
									>
																		...
																		<CommandGroup>
																			{c.registration.schools.map(
																				(
																					...
																					>
																						<Check
																							className={`mr-2 h-4 w-4 ${school.toLowerCase() ===
																								field.value
																								? "block"
																								: "hidden"
																								} `}
										...
										<FormField
											...
											render={({ field }) => (
												<FormItem
													className={`${isLocalUniversitySelected
																		...
																		<CommandGroup>
																			{c.registration.majors.map(
																				(
																					...
																					>
																						<Check
																							className={`mr-2 h-4 w-4 overflow-hidden ${major.toLowerCase() ===
																								field.value
																								? "block"
																								: "hidden"
																								} `}
										...
										render={({ field }) => (
											<FormItem>
												...
												<FormControl>
													<div
														{...getRootProps()}
														className={`border-2${uploadedFile
															? ""
															: "cursor-pointer"
